        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 flex-shrink-0 drop-shadow-[0_0_8px_rgba(251,191,36,0.3)]">
                <svg viewBox="0 0 100 100" className="w-full h-full" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M50 15C47 15 44 17 44 20C44 22 45 23.5 47.5 24.5C48.5 24.9 49 25.5 49 26V30" stroke="url(#amber-grad-ft)" strokeWidth="3" strokeLinecap="round" />
                  <path d="M49 30L15 47C13 48 12 50 12 53H88C88 50 87 48 85 47L51 30" stroke="url(#amber-grad-ft)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M22 50L50 36L78 50" stroke="url(#amber-grad-ft)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" opacity="0.6"/>
                  <path d="M40 53V48H60L40 38V33H60" stroke="url(#amber-grad-ft)" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"/>
                  <defs>
                    <linearGradient id="amber-grad-ft" x1="12" y1="15" x2="88" y2="53" gradientUnits="userSpaceOnUse">
            ...
            <div className="flex items-center space-x-3 pt-2">
              ...
              <a
                ...
                title="ZORUQ Instagram (@shopping_solution_)"
              >
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
